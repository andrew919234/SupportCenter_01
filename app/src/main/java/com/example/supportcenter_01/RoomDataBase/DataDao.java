...
//
//    @Query("INSERT INTO " + tableName + "(email) VALUES(:email,:password)")
//    void insertData(String email, String password);
//
//    @Query("INSERT INTO " + tableName + "(id,email) VALUES(:id,:email,:password)")
...
//     * 複雜(?)更新資料的方法
//     */
//    @Query("UPDATE " + tableName + " SET email = :email WHERE id = :id")
